package com.plantiq.data.remote

import com.plantiq.data.model.*
...
class PlantIqApi(private val client: HttpClient) {
    ...
    suspend fun createWateringSchedule(request: CreateWateringScheduleDto): HttpResponse {
    ...
    suspend fun updateWateringSchedule(scheduleId: Int, request: UpdateWateringScheduleDto): HttpResponse {
    ...
    suspend fun createWateringEvent(request: WateringEventResponseDto): HttpResponse {
    ...
    suspend fun createPlantSpecies(request: CreatePlantSpeciesDto): HttpResponse {
